...
const DailyEssentials = () => {
  // Daily essentials (bestsellers) — SWR cache shared across renders.
...
const FeaturedProducts = () => {
  // Fresh picks (featured) — SWR cache shared across renders.
...
/* ================================================================ */
const NewArrivals = () => {
  // New arrivals — SWR cache shared across renders.
