    ...
    children: [
      {
        ...
        icon: Boxes,
        permissions: ['view-stock-valuation-report', 'view-reorder-report', 'view-stock-movement-report', 'view-batch-expiry-report', 'view-stock-status-report', 'view-low-stock-report'],
        children: [
          ...
          { name: 'Purchase List', href: '/reports/purchase-list', icon: FileSpreadsheet, permission: 'view-purchase-report' },
        ],
      },
      {
        name: 'Sales Reports',
        icon: TrendingUp,
        permissions: ['view-sales-by-product-report', 'view-sales-by-customer-report', 'view-sales-trend-report', 'view-customer-aging-report'],
        children: [
      ...
      },
      {
        ...
        icon: ListMinus,
        permissions: ['view-po-summary-report', 'view-supplier-aging-report'],
        children: [
      ...
      },
      {
        ...
        permissions: ['view-pos-daily-sales-report', 'view-pos-session-report'],
        children: [
      ...
      },
      {
        ...
        icon: FileSpreadsheet,
        permissions: ['view-ar-aging-report', 'view-ap-aging-report', 'view-failed-journal-report', 'view-trail-balance', 'view-balance-sheet', 'view-profit-loss', 'view-cash-flow', 'view-accounts'],
        children: [
      ...
      },
      {
        ...
        icon: Warehouse,
        permissions: ['view-warehouse-stock-report'],
        children: [
      ...
      },
      {
        name: 'System Reports',
        icon: ScrollText,
        permissions: ['view-audit-log-report', 'view-activity-log-report'],
        children: [
