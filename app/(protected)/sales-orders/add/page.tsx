                ...
                >
                  ...
                  <div className="col-span-4">
                    <input
                      ...
                      onFocus={e => e.target.select()}
                      placeholder="0.00"
                      className={`${inputCls} text-right font-semibold [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none ${hasErr(`items.${idx}.unit_price`) ? 'border-red-500' : ''}`}
                    />
                  </div>
