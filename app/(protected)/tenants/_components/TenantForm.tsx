  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isEditMode && editRef) {
        ...
        await tenantService.updateTenant(editRef, submitData as any);
      ...
      if (error.response?.data?.errors) {
        ...
        notify.error(error.response?.data?.message || (isEditMode ? 'Failed to update tenant' : 'Failed to create tenant'));
      }
    } finally {
      setIsLoading(false);
    }
