        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-4 max-w-3xl mx-auto">
              ...
              monitoring stock movements, and optimizing replenishment.
            </p>
            <p className="text-lg text-gray-500 mb-8 max-w-3xl mx-auto">
              Eliminate manual inefficiencies, reduce errors, and gain real-time visibility into
              your entire inventory ecosystem.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white rounded-xl shadow-lg p-8 mb-16">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              <strong>Universal Inventory management</strong> is a critical component of operational
              efficiency for businesses that handle physical goods, whether in retail,
              manufacturing, distribution, or warehousing. Traditionally, inventory control relied
              heavily on manual processes, spreadsheets, or basic software, which often led to{' '}
              <span className="text-red-600 font-semibold">
                inaccuracies, stockouts, overstocking, and inefficient use of resources
              </span>
              .
            </p>
            <p>
              An <strong>Universal Inventory Management System (UIMS)</strong> is designed to
              address these challenges by providing a centralized, automated platform for tracking
              inventory across multiple locations, monitoring stock movements, and optimizing
              replenishment. Advanced IMS solutions can integrate with other business systems such
              as <strong>Enterprise Resource Planning (ERP)</strong>,{' '}
              <strong>Customer Relationship Management (CRM)</strong>, and{' '}
              <strong>e-commerce platforms</strong>, enabling seamless data flow and reducing the
              risk of errors.
            </p>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: Zap,
                title: 'Eliminate Manual Inefficiencies',
                desc: 'Replace spreadsheets with centralized automation to reduce errors and stockouts',
              },
              {
                icon: Target,
                title: 'Real-Time Visibility',
                desc: 'Track inventory levels, movements, and status across all locations instantly',
              },
              {
                icon: RefreshCw,
                title: 'Automate Replenishment',
                desc: 'Implement smart reordering to maintain ideal stock levels automatically',
              },
              {
                icon: Database,
                title: 'Seamless Integration',
                desc: 'Connect with ERP, CRM, e-commerce, and supplier systems effortlessly',
              },
              {
                icon: BarChart3,
                title: 'Enhanced Decision-Making',
                desc: 'Robust analytics for data-driven purchasing and forecasting',
              },
              {
                icon: Globe,
                title: 'Support Scalability',
                desc: 'Manage global supply chains and multi-channel sales complexity',
              },
              {
                icon: CheckCircle,
                title: 'Customer Satisfaction',
                desc: 'Ensure product availability and timely order fulfillment',
              },
              {
                icon: TrendingUp,
                title: 'Reduce Costs',
                desc: 'Minimize carrying costs, wastage, and optimize resources',
              },
              {
                icon: Shield,
                title: 'Accuracy & Reliability',
                desc: 'System controls that eliminate human errors in operations',
              },
              {
                icon: FileText,
                title: 'Future-Proof Operations',
                desc: 'Flexible system adapting to new business models and demands',
              },
            ].map((item, idx) => (
              <div
                key={idx}
                className="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition border border-gray-100"
              >
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: '💊',
                title: 'Pharmacy & Drug Stores',
                desc: 'Medicine tracking, expiry management, prescription handling',
              },
              {
                icon: '🛒',
                title: 'Grocery & Supermarkets',
                desc: 'Perishable goods, bulk items, weight-based inventory',
              },
              {
                icon: '🏢',
                title: 'Real Estate Agencies',
                desc: 'Property listings, equipment inventory, office supplies',
              },
              {
                icon: '💻',
                title: 'Electronics & Computer Shops',
                desc: 'Serialized items, warranty tracking, accessories',
              },
              {
                icon: '👕',
                title: 'General Retail',
                desc: 'Apparel, hardware, bookstore, stationery management',
              },
              {
                icon: '🏪',
                title: 'Multi-Store Chains',
                desc: 'Centralized inventory across multiple locations',
              },
              {
                icon: '📦',
                title: 'Warehouse Operations',
                desc: 'Bulk storage, bin management, third-party logistics',
              },
              {
                icon: '🏭',
                title: 'Manufacturing',
                desc: 'Raw materials, work-in-progress, finished goods tracking',
              },
            ].map((item, idx) => (
              <div
                key={idx}
                className="bg-linear-to-br from-indigo-50 to-purple-50 rounded-lg p-6 hover:shadow-lg transition border border-indigo-100"
              >
        ...
        <div className="bg-linear-to-r from-indigo-600 to-purple-600 rounded-xl shadow-2xl p-12 text-center text-white">
          <h2 className="text-4xl font-bold mb-4">Ready to Transform Your Inventory Management?</h2>
          <p className="text-xl mb-8 text-indigo-100">
            Join businesses that have eliminated inefficiencies and gained complete control over
            their inventory.
          </p>
          <Link
            href={isAuthenticated ? '/dashboard' : '/login'}
